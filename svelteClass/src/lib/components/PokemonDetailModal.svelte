<script>
    ...
    //O modal precisa de duas coisas para funcionar: o objeto pokemon 
    //com os detalhes e a função onClose para ser chamada quando o 
    //usuário clicar no botão de fechar.
</script>
